...
/**
 * Class World
 * @package MauticPlugin\HelloWorldBundle
 */
class Call extends FormEntity
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('call_centre')
            ->setCustomRepositoryClass('MauticPlugin\CustomCallBundle\Entity\CallRepository');
