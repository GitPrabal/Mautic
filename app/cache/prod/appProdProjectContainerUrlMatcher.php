        ...
        if (0 === strpos($pathinfo, '/s')) {
            ...
            if (0 === strpos($pathinfo, '/s/contacts')) {
                ...
                if (preg_match('#^/s/contacts(?:/(?P<page>\\d+))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'mautic_contact_index')), array (  '_controller' => 'MauticPlugin\\CustomCrmBundle\\Controller\\LeadController::indexAction',  'page' => 0,));
                }
                ...
                if (0 === strpos($pathinfo, '/s/contacts/contact/export') && preg_match('#^/s/contacts/contact/export/(?P<contactId>\\d+)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'mautic_contact_export_action')), array (  '_controller' => 'MauticPlugin\\CustomCrmBundle\\Controller\\LeadController::contactExportAction',));
                }
            ...
            if (0 === strpos($pathinfo, '/s/co')) {
                ...
                if (0 === strpos($pathinfo, '/s/contacts') && preg_match('#^/s/contacts/(?P<objectAction>[^/]++)(?:/(?P<objectId>[a-zA-Z0-9_-]+))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'mautic_contact_action')), array (  '_controller' => 'MauticPlugin\\CustomCrmBundle\\Controller\\LeadController::executeAction',  'objectId' => 0,));
                }
            ...
            if (0 === strpos($pathinfo, '/s/opportunities')) {
                // mautic_customcrm_opportunity_index
                if (preg_match('#^/s/opportunities(?:/(?P<page>\\d+))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'mautic_customcrm_opportunity_index')), array (  '_controller' => 'MauticPlugin\\CustomCrmBundle\\Controller\\OpportunityController::indexAction',  'page' => 0,));
                }

                // mautic_customcrm_opportunity_action
                if (preg_match('#^/s/opportunities/(?P<objectAction>[^/]++)(?:/(?P<objectId>[a-zA-Z0-9_-]+))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'mautic_customcrm_opportunity_action')), array (  '_controller' => 'MauticPlugin\\CustomCrmBundle\\Controller\\OpportunityController::executeAction',  'objectId' => 0,));
                }

            }

            if (0 === strpos($pathinfo, '/s/tasks')) {
                // ddi_lead_actions_task_index
                if ('/s/tasks' === $pathinfo) {
                    return array (  '_controller' => 'MauticPlugin\\CustomCrmBundle\\Controller\\TaskController::indexAction',  '_route' => 'ddi_lead_actions_task_index',);
                }

                // mautic_task_action
                if (preg_match('#^/s/tasks/(?P<objectAction>[^/]++)(?:/(?P<objectId>\\d+))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'mautic_task_action')), array (  '_controller' => 'MauticPlugin\\CustomCrmBundle\\Controller\\TaskController::executeTaskAction',  'objectId' => 0,));
                }
